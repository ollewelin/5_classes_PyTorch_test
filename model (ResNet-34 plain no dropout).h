...
struct ObscureResNetImpl : public torch::nn::Module 
{
  ...
  :    // conv1(torch::nn::Conv2dOptions(3, 20, /*kernel_size=*/5).stride(2)),
   ...
   // x = torch::relu(x);
    ...
    x = torch::relu(torch::avg_pool2d(conv1->forward(x), 2));
