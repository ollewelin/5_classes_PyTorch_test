...
auto main() -> int {
  ...
  // torch::load(optimizer, "./best_model.pt");
    ...
    std::string test_file1 = "./data/class0/503.jpg";
    std::string test_file2 = "./data/class1/503.jpg";
    std::string test_file3 = "./data/class2/503.jpg";
    std::string test_file4 = "./data/class3/503.jpg";
    std::string test_file5 = "./data/class4/503.jpg";
